# Fair University Ranking (FairRank): Global Academic Prestige Rankings

Fair University Ranking (FairRank) is a data-driven, globally fair university prestige ranking system. Unlike traditional rankings (like QS or Times Higher Education) that rely on subjective surveys or financial metrics, FairRank computes academic prestige by analyzing the global **PhD-to-Faculty employment network**. 
...
Academic prestige is defined as the ability to produce top-tier scholars. FairRank models this as a **directed graph ($G$)**:
...
To eliminate regional census bias (e.g., historical datasets only covering US universities), FairRank is built entirely on globally uniform open APIs:
